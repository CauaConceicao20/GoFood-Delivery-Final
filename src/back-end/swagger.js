export default {
  ...
  "components": {
    ...
    "schemas": {
      ...
      "RestauranteUpdateRequest": {
        "type": "object",
        "properties": {
          "nome": {
            "type": "string",
            "example": "Restaurante Delícia Atualizado"
          },
          "razaoSocial": {
            "type": "string",
            "example": "Restaurante Delícia LTDA"
          ...
          "descricao": {
            "type": "string",
            "example": "O melhor restaurante da cidade, agora com novidades"
          },
          "formasPagamento": {
            "type": "array",
            "items": {
  ...
  "paths": {
    ...
    "/api/v1/auth/refresh-token": {
      "post": {
        ...
        "description": "Atualiza o token JWT do usuário",
        "tags": ["Autenticação"],
        "responses": {
          "200": {
    ...
    "/api/v1/restaurantes/buscaRestaurante/{id}": {
      "get": {
    ...
    "/api/v1/restaurantes/atualizaRestaurante/{id}": {
      "put": {
              ...
              "schema": {
                ...
                "properties": {
                  ...
                  "arquivo": {
                    "type": "string",
                    "format": "binary",
                    "description": "Nova imagem do restaurante (opcional)"
                  }
                }
              }
            }
    ...
    "/api/v1/restaurantes/excluirRestaurante/{id}": {
      "delete": {
        "summary": "Excluir restaurante",
        "description": "Exclui logicamente um restaurante",
        "tags": ["Restaurantes"],
        "security": [
          {
            "bearerAuth": []
                ...
                "schema": {
                  ...
                  "items": {
                    ...
                    "properties": {
                      ...
                      "descricao": {
                        "type": "string",
                        "example": "Pizza tradicional italiana"
                      },
                      "preco": {
                        "type": "number",
                        "example": 45.90
                      ...
                      "restaurante": {
                        ...
                        "properties": {
                          ...
                          "nome": {
                            "type": "string",
                            "example": "Pizzaria Italiana"
                          }
                        }
                      },
                      "fotoUrl": {
                        "type": "string",
                        "example": "http://localhost:3000/uploads/pizza.jpg"
                      }
                    }
                  }
                }
    ...
    "/api/v1/produtos/buscarProdutoPorId/{id}": {
      "get": {
    ...
    "/api/v1/carrinhos/aumentarQuantidade": {
      "put": {
        "summary": "Aumentar quantidade de item no carrinho",
        "description": "Aumenta a quantidade de um item no carrinho",
        "tags": ["Carrinho"],
        "security": [
          {
            "bearerAuth": []
        ...
        "responses": {
          ...
          "400": {
            "description": "Dados inválidos ou quantidade máxima atingida"
          },
          "401": {
            "description": "Não autorizado"
          }
    ...
    "/api/v1/carrinhos/diminuirQuantidade": {
      "put": {
        "summary": "Diminuir quantidade de item no carrinho",
        "description": "Diminui a quantidade de um item no carrinho",
        "tags": ["Carrinho"],
        "security": [
          {
            "bearerAuth": []
    ...
    "/api/v1/carrinhos/removerItem/{produtoId}": {
      "delete": {
